...
bool comp_priority(Process P, Process Q) //to sort according to arrival time
{
...
int main()
{
    ...
    sort(p.begin(),p.end(),comp_priority); //sorting the Processes according to arrival time
    ...
    */
    ...
    while(completed != n)   //
    {
        ...
        for(int i = 0; i < n; i++)
        {
            ...
            {
				if (high_pri < p[i].priority)       //zero is lowest priority
                {
